...
-(void)viewDidLoad{
    ...
    NSString *content =[NSString stringWithFormat:@"<image src=\"%@\" width=\"200\" height=\"120\">@爱上无名氏<link url=\"http://www.baidu.com\" name=\"Futura\" size=\"20\" color=\"blue\" >Love ***无名氏个大傻逼<font name=\"Futura\" size=\"12\" color=\"red\">you  I believe that Anything is possible 10 to CoreTextDome, but to the 19 today or generation of packaging, had love who know why ah?Please ask!<font name=\"Futura\">",url];
    CoreTextData *data = [FrameParser parserWithPropertyContent2:content defaultCfg:config];
